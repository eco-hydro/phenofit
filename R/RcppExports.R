...
logistic <- function(par, t, pred) {
    invisible(.Call(`_phenofit_logistic`, par, t, pred))
}

doubleLog_Zhang <- function(par, t, pred) {
    invisible(.Call(`_phenofit_doubleLog_Zhang`, par, t, pred))
}

doubleLog_AG <- function(par, t, pred) {
    invisible(.Call(`_phenofit_doubleLog_AG`, par, t, pred))
}

doubleLog_Beck <- function(par, t, pred) {
    invisible(.Call(`_phenofit_doubleLog_Beck`, par, t, pred))
}

doubleLog_Elmore <- function(par, t, pred) {
    invisible(.Call(`_phenofit_doubleLog_Elmore`, par, t, pred))
}

doubleLog_Gu <- function(par, t, pred) {
    invisible(.Call(`_phenofit_doubleLog_Gu`, par, t, pred))
}

doubleLog_Klos <- function(par, t, pred) {
    invisible(.Call(`_phenofit_doubleLog_Klos`, par, t, pred))
}
