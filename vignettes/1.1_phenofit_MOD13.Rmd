...
fwrite(df, 'phenofit_MOD13A1_st_20.csv')
```
...
![figure](../Figure1_phenofit_curve_fitting.svg)
...
# get_phenofit(d)
Cairo::CairoPDF("Figure1_phenofit_curve_fitting_v2.pdf", 11, 6)
fits  <- list()
print <- FALSE
for(i in seq_along(Ids)){
    runningId(i)
    d <- df[Id == i, ]
    fits[[i]] <- get_phenofit(d)
    #dlply(df[Id < 3], .(Id), get_phenofit, .progress = "text")    
}
dev.off()
```
